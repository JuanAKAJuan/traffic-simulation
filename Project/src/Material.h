...
struct Material {
    ...
    /// Specify the dissolve for the current model. "factor" is the amount this
    /// material dissolves into the background. A factor of 1.0 is fully
    /// opaque.This is the default when a new material
