...
Vector3 computeRotatedVector(Vector3 input, float angle)
{
    ...
    // result.x += (rotationMatrix[0][0] * input.x + rotationMatrix[0][1] *
    // input.y + rotationMatrix[0][2] * input.z); result.y +=
    // (rotationMatrix[1][0] * input.x + rotationMatrix[1][1] * input.y +
    // rotationMatrix[1][2] * input.z); result.z += (rotationMatrix[2][0] *
    // input.x + rotationMatrix[2][1] * input.y + rotationMatrix[2][2] * input.z);
